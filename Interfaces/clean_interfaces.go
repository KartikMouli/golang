...
Q.Interfaces should have as ____ methods as possible
...
Q.It's okay for interfaces to be aware of the types that satisfy them
...
Q.Why is it best to keep interfaces small?

To reduce the complexity of implementation
To only define the essential behaviors    = answer
To make the code more flexible for future changes


Q.Interfaces allow you to define a method's behavior once and use it for many different types
